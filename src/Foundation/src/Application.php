...
class Application extends LaravelApplication
{
    ...
    public static function configure(?string $basePath = null): ApplicationBuilder
    {
        return parent::configure($basePath)
            ...
            ->withCommands([base_path('app/Console/Commands'), base_path('routes/console.php')])
     ...
     */
    public static function create(?string $basePath = null): LaravelApplication
    {
        return static::configure($basePath)->create();
    }
}
